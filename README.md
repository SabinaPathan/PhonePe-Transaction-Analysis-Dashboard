...
## Dataset
PhonePe transaction, insurance, loan, money transfer, and recharge/bill data for the period **01-01-2024 to 30-12-2024**, structured into separate fact tables (`All_Transactions`, `All_Users`, `Insurance`, `Loans`, `Money_Transfer`, `Recharge_Bills`).

## Tools Used
- Power BI Desktop (data modeling, DAX measures, visuals)
- Python (for initial data extraction/transformation prior to loading into Power BI)
...
## How to Explore
Since GitHub cannot render `.pbix` files natively, the screenshots above capture each page. To interact with the live dashboard:
1. Download `PhonePe-Transaction-Analysis-Dashboard.pbix` and open it in [Power BI Desktop](https://powerbi.microsoft.com/desktop/) (free)

##Files 
# PhonePe Pulse Dashboard — Power BI
...
## How to Explore
Since GitHub cannot render `.pbix` files natively, the screenshots above capture each page. To interact with the live dashboard:
1. PhonePe-Transaction-Analysis-Dashboard.pbix` and open it in [Power BI Desktop](https://powerbi.microsoft.com/desktop/) 

## Files
- `/screenshots` — PNG exports of all 5 dashboard pages
- `README.md` — this file
- `PhonePe_Pulse_Dashboard.pbix` — the full Power BI report
- `/screenshots` — PNG exports of all 5 dashboard pages
- `README.md` — this file
