...
## How to Explore
Since GitHub cannot render `.pbix` files natively, the screenshots in `/Screenshots` capture each page. To interact with the live dashboard, download `PhonePe-Transaction-Analysis-Dashboard.pbix` and open it in [Power BI Desktop](https://powerbi.microsoft.com/desktop/) (free).
